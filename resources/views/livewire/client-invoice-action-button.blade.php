<div class="d-flex justify-content-center">
    @if ($row->status_label != 'Paid')
        <a class="btn px-0 text-info fs-3 py-2" data-bs-toggle="tooltip" title="{{ __('messages.invoice.make_payment') }}" href="{{ route('clients.payments.show', $row->id) }}" data-id="{{ $row->id }}"
            data-turbo="false"><i class="fa-solid fa-money-bill"></i></a>
    @endif
